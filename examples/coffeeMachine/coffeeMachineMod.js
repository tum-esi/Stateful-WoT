...
exports.launchCoffeeMachineServer = void 0;
...
function launchCoffeeMachineServer(WoT, servNum, deviceNum) {
    var _this = this;
    ...
    var td = {
        ...
        "@type": "Thing",
        title: "Virtual Coffee Machine ".concat(servNum, "_").concat(deviceNum),
        description: "A virtual coffee machine implementing basic behavior. Action Affordances require a certain amount of time to finish.",
        properties: {
            allAvailableResources: {
                type: "object",
                description: "Current level of all available resources given as an integer percentage for each particular resource.\nThe data is obtained from the machine's sensors.",
                readOnly: true,
                properties: {
            ...
            taskStatus: {
                type: "string",
                description: "The status of the task given initiated using the 'makeDrink' action affordance.",
                enum: ["init", "checking", "checkOk", "outOfResource", "grinding", "heatingWater", "heatingMilk", "brewing", "addChocolate", "pouring", "finished"],
                observable: true,
                readOnly: true
            },
        },
        actions: {
            makeDrink: {
                description: "Make a drink from available list of beverages. Accepts drink id, size and quantity as input.\n Brews one medium americano if no above-mentioned inputs are not specified. The status of the given task can be viewed using the 'taskStatus' property affordance",
                input: {
                    drinkId: {
                        type: "string",
    ...
    (function () { return __awaiter(_this, void 0, void 0, function () {
        var thing, lastState, lastContext, thingTD, promise, thingTD_1, baseHref, e_1;
        var _this = this;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    thing.setPropertyReadHandler("allAvailableResources", function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                    ...
                    thing.setPropertyReadHandler("possibleDrinks", function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                    ...
                    thing.setPropertyReadHandler("taskStatus", function () {
                        var services = service.getSnapshot().context["_spawnedServices"];
                        var servicesKeys = Object.keys(services);
                        var currentTask = servicesKeys.find(function (serviceId) { return serviceId === "busy.".concat(service.getSnapshot().context._spawnedServicesCounter - 1); });
                        if (currentTask)
                            return services[currentTask].getSnapshot().value;
                    });
                    /*=========================================== Property Write Handlers ===========================================*/
                    /*============================================ Invoke Action Handlers ===========================================*/
                    thing.setActionHandler("makeDrink", function (inputData, options) { return __awaiter(_this, void 0, void 0, function () {
                        var currentState, responsePromise, payload, possibleDrinks, data;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    ...
                                    if (payload !== undefined && payload.drinkId !== null && !possibleDrinks.includes(payload.drinkId))
                                        throw new Error(payload.drinkId + " is not a possible drink");
                                    service.send({
                                        type: "taskReceived",
                                        data: {
                                            payload: payload,
                                            uriVariables: options === null || options === void 0 ? void 0 : options.uriVariables,
                                        },
                                    });
                    ...
                    thing.setActionHandler("refillResource", function (inputData, options) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    thing.setEventUnsubscribeHandler("outOfResource", function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/];
                        });
                    }); });
                    service.onTransition(function (state, context) {
                        ...
                        if (service.getSnapshot().value["wrapper"]["coffeeOutlet"] === "busy" && lastState.value["wrapper"]["coffeeOutlet"] === "idle") {
                            var currentCounter = service.getSnapshot().context._spawnedServicesCounter;
                            var currentTask = service.getSnapshot().context["_spawnedServices"]["busy.".concat(currentCounter - 1)];
                            if (currentTask)
                                currentTask.onTransition(function (state) {
                                    if (state.changed) {
                                        console.log("".concat(td.title, ":"));
                                        console.log("Recieved Task Event: ".concat(JSON.stringify(state.event)));
                                        console.log("Current Task State: ".concat(JSON.stringify(state.value)));
                                    }
                                    thing.emitPropertyChange("taskStatus");
                                });
                        }
                        lastState = state;
                        lastContext = context;
                    });
                    thingTD = thing.getThingDescription();
                    _c.label = 2;
                case 2:
                    _c.trys.push([2, 4, , 5]);
                    service.start();
                    console.log("\n------------------------------------------------------------------\n");
                    promise = thing.expose();
                    return [4 /*yield*/, promise];
                case 3:
                    _c.sent();
                    thingTD_1 = thing.getThingDescription();
                    baseHref = (_b = (_a = thingTD_1.properties) === null || _a === void 0 ? void 0 : _a.allAvailableResources) === null || _b === void 0 ? void 0 : _b.forms[0].href.replace("/properties/allAvailableResources", "");
                    console.log("".concat(thingTD_1.title, " is exposed on ").concat(baseHref));
                    return [3 /*break*/, 5];
                case 4:
                    e_1 = _c.sent();
                    console.log("Error in ".concat(thingTD.title, ": ").concat(e_1));
                    console.log("TD: ".concat(JSON.stringify(thingTD)));
                    return [3 /*break*/, 5];
...
exports.launchCoffeeMachineServer = launchCoffeeMachineServer;
var servient = new core_1.Servient();
core_1.Helpers.setStaticAddress("localhost");
servient.addServer(new binding_http_1.HttpServer({ port: 8888 }));
servient.start().then(function (WoT) {
    launchCoffeeMachineServer(WoT, 1, 1);
});
